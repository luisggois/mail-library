...
# noinspection PyTypeChecker,PyListCreation
def l2c(l):
...
# noinspection PyTypeChecker,PyPep8Naming,PyUnusedLocal
...
def des_encript(instr, ks, encrypt):
    # instr  - U32[]
    # output - U32[]
    ...
    r, a, t = PERM_OP((r, a, t), 4, U32(0x0f0f0f0f))
    a, r, t = PERM_OP((a, r, t), 16, U32(0x0000ffff))
    r, a, t = PERM_OP((r, a, t), 2, U32(0x33333333))
    a, r, t = PERM_OP((a, r, t), 8, U32(0x00ff00ff))
    r, a, t = PERM_OP((r, a, t), 1, U32(0x55555555))
    ...
    if encrypt:
        for i in range(0, 32, 4):
            rtup, u, t, s = D_ENCRYPT((a, r, i + 0), u, t, s)
            a = rtup[0]
            r = rtup[1]
            rtup, u, t, s = D_ENCRYPT((r, a, i + 2), u, t, s)
            r = rtup[0]
            a = rtup[1]
    else:
    ...
    a, r, t, u = U32(0), U32(0), U32(0), U32(0)

    return output


def des_ecb_encrypt(instr, ks, encrypt):
    # instr  - des_cblock - UChar[8]
